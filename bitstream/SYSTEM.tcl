...
################################################################
# This is a generated script based on design: SYSTEM_TEST_PROJECT
#
...
# source SYSTEM_TEST_PROJECT_script.tcl
...
set design_name SYSTEM_TEST_PROJECT
...
\
  ...
  # Create instance: PRE_SYN_DMA, and set properties
  set PRE_SYN_DMA [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_dma:7.1 PRE_SYN_DMA ]
  set_property -dict [list \
  ...
  # Create instance: SPIKE_DMA, and set properties
  set SPIKE_DMA [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_dma:7.1 SPIKE_DMA ]
  set_property -dict [list \
    CONFIG.c_include_mm2s {1} \
    CONFIG.c_include_s2mm {0} \
    CONFIG.c_include_sg {0} \
  ...
  # Create instance: POST_SYN_DMA, and set properties
  set POST_SYN_DMA [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_dma:7.1 POST_SYN_DMA ]
  set_property -dict [list \
  ...
  connect_bd_intf_net -intf_net POST_SYN_DMA_M_AXI_S2MM [get_bd_intf_pins POST_SYN_DMA/M_AXI_S2MM] [get_bd_intf_pins axi_interconnect_1/S00_AXI]
  connect_bd_intf_net -intf_net PRE_SYN_DMA_M_AXI_MM2S [get_bd_intf_pins PRE_SYN_DMA/M_AXI_MM2S] [get_bd_intf_pins axi_interconnect_2/S00_AXI]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_dma_0_M_AXIS_MM2S] [get_bd_intf_pins PRE_SYN_DMA/M_AXIS_MM2S] [get_bd_intf_pins system_ila_0/SLOT_1_AXIS]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins ps7_0_axi_periph/M00_AXI] [get_bd_intf_pins PRE_SYN_DMA/S_AXI_LITE]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins ps7_0_axi_periph/M01_AXI] [get_bd_intf_pins SYSTEM_0/SYSTEM_INTERFACE]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins ps7_0_axi_periph/M02_AXI] [get_bd_intf_pins SPIKE_DMA/S_AXI_LITE]
  ...
  assign_bd_address -offset 0x40410000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs PRE_SYN_DMA/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0x40420000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs SPIKE_DMA/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs SYSTEM_0/SYSTEM_INTERFACE/SYSTEM_INTERFACE_reg] -force
  assign_bd_address -offset 0x00000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces PRE_SYN_DMA/Data_MM2S] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] -force
  assign_bd_address -offset 0x00000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SPIKE_DMA/Data_MM2S] [get_bd_addr_segs processing_system7_0/S_AXI_HP1/HP1_DDR_LOWOCM] -force
  assign_bd_address -offset 0x00000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces POST_SYN_DMA/Data_S2MM] [get_bd_addr_segs processing_system7_0/S_AXI_HP2/HP2_DDR_LOWOCM] -force
